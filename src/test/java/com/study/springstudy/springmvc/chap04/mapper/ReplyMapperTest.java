...
class ReplyMapperTest {
    ...
    @Test
    @DisplayName("103번 댓글 내용을 수정하면 다시 조회했을 때 수정된 내용이 조회되어야 한다.")
    void modifyTest() {
        // given
        int replyNo = 103;
        ...
        Assertions.assertEquals(newReplyText,
                replyMapper.findOne(replyNo).getReplyText());
    }
}